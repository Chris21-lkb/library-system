    ...
    <div class="editcontent">
        <div class="editbooks">
            ...
            <form action="editbook" method="post" enctype="multipart/form-data">
                @csrf
                <input type="text" name="bookname" placeholder="new book name" required >
                <input type="text" name="author" placeholder="new Author" required><br/>
                <input type="number" name="publishdate" placeholder="new publish year" required >
                <input type="number" step="0.01" name="price" placeholder="new book price" required><br/>
